...
function displayImage() {
    ...
    + '<tr><td>Doujinshi popularity [(optional)tags]</td>'
    + '<td>Get the 5 most popular doujinshis given some tags, if none are provide, give the recently popular</td><td>Doujinshi</td><td>NSFW channel only</td></tr>'
...
function displayJapan() {
    ...
    + '<tr><td>Arknights charac [(optional)skill level] [name]</td>'
